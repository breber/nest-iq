...
public class Structure implements Parcelable {
    ...
    private static List<String> convertToList(JSONArray array) {
        ...
        try {
            ...
            Log.e(TAG, "Unable to parse array from json: " + array.toString());
        }
        return list;
     ...
     * @see com.nestapi.lib.API.Structure.ETA
     */
    public ETA getETA() {
        return mETA;
    }
    ...
    public static class ETA implements Parcelable {
        ...
        public JSONObject toJSON() {
            ...
            try {
                ...
                // null keys.
                Log.e(TAG, "Unable to generate JSON object for ETA", excep);
            }
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeString(mEstimatedArrivalWindowBegin);
            dest.writeString(mEstimatedArrivalWindowEnd);
        }
